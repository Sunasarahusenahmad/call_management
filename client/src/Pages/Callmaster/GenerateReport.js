...
const GenerateReport = () => {
  ...
  const getPerCall = async () => {
    try {
      ...
      const InstituteRes = await axios.get(`/getinstitutename/${InstiId}`);
      ...
      // Fetch the call type name based on the ID
      const modelRes = await axios.get(`/getmodelname/${ModelID}`);
      ...
      // Fetch the call type name based on the ID
      const makeRes = await axios.get(`/getmakename/${MakeID}`);
      ...
      // Fetch the call type name based on the ID
      const serialRes = await axios.get(`/getserialnos/${SerialNO}`);
