...
const AllCalltype = () => {
  ...
  const savedata = async (e) => {
    ...
    if (!callType) {
      ...
      try {
        await axios.post("/addcalltype", group)
          .then((res) => {
            toast.success('Call Type Added successful!');
  ...
  const trashCalltype = async (id) => {
    try {
      if (window.confirm("Are you sure you want to remove this Call Type")) {
        const res = await axios.delete(`/trashcalltype/${id}`);
        window.location.reload();
        getCalltype();
      }
    } catch (error) {
                  ...
                  <div className="row">
                    ...
                    <div className="col-xl-8 col-lg-7">
                      <div className="card shadow mb-4">
                        ...
                        <div
                          ...
                          <h6 className="m-0 font-weight-bold text-primary">All Call Type</h6>
                            ...
                            <table class="table" id="dataTable" width="100%">
                              <thead>
                                <tr style={{ cursor: 'pointer' }}>
                                  <th scope="col">ID</th>
                                  <th onClick={toggleSortDirection}>Call Type <span>
                                        ...
                                        <td>
                                          ...
                                          <p className="p-0 m-0 tred " style={{ fontSize: '14px' }}>
                                            <div className="d-flex">
                                              ...
                                              <Link to={'/editcalltype'} state={{ id: item.id }} className='text-decoration-none'><p className="p-0 m-0">Edit | </p></Link>
                                              <p className="text-danger p-0 m-0" onClick={() => { trashCalltype(item.id) }}>&nbsp;Trash </p>
                                            </div>
                                          </p>
                                        </td>
                                      </tr>
                    ...
                    <div className="col-xl-4 col-lg-5">
                      <div className="card shadow mb-4">
                        ...
                        <div
                          className="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                          <h6 className="m-0 font-weight-bold text-primary">Add Call Type</h6>
                        </div>
                        {/*  <!-- Form Body --> */}
                        <div className="card-body" style={{ fontFamily: 'Signika Negative', fontSize: '15px' }}>
                          <form onSubmit={savedata}>
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" placeholder="Enter Call Type" value={callType} onChange={(e) => { setCallType(e.target.value) }} />
                            </div>
