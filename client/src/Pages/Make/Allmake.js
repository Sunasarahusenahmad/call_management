...
const Allmake = () => {
  ...
  const savedata = async (e) => {
    ...
    if (!makeName) {
      ...
      try {
        await axios.post("/addmake", group)
          .then((res) => {
            toast.success('Make Added successful!');
  ...
  const trashMake = async (id) => {
    try {
      if (window.confirm("Are you sure you want to remove this Make")) {
        const res = await axios.delete(`/trashmake/${id}`);
        window.location.reload();
        getMake();
      }
    } catch (error) {
                  ...
                  <div className="row">
                    ...
                    <div className="col-xl-8 col-lg-7">
                      <div className="card shadow mb-4">
                        ...
                        <div
                          ...
                          <h6 className="m-0 font-weight-bold text-primary">All Makes</h6>
                        </div>
                        {/*  <!-- Table Body --> */}
                            ...
                            <table class="table" id="dataTable" width="100%">
                              <thead>
                                <tr style={{ cursor: 'pointer' }}>
                                  <th scope="col">ID</th>
                                  <th onClick={toggleSortDirection}>Make Name <span>
                                        ...
                                        <td>
                                          ...
                                          <p className="p-0 m-0 tred " style={{ fontSize: '14px' }}>
                                            <div className="d-flex">
                                              ...
                                              <Link to={'/editmake'} state={{ id: item.id }} className='text-decoration-none'><p className="p-0 m-0">Edit | </p></Link>
                                              <p className="text-danger p-0 m-0" onClick={() => { trashMake(item.id) }}>&nbsp;Trash </p>
                                            </div>
                                          </p>
                                        </td>
                                      </tr>
                    ...
                    <div className="col-xl-4 col-lg-5">
                      <div className="card shadow mb-4">
                        ...
                        <div
                          className="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                          <h6 className="m-0 font-weight-bold text-primary">Add Make</h6>
                        </div>
                        {/*  <!-- Form Body --> */}
                        <div className="card-body" style={{ fontFamily: 'Signika Negative', fontSize: '15px' }}>
                          <form onSubmit={savedata}>
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" placeholder="Enter Make Name" value={makeName} onChange={(e) => { setMakeName(e.target.value) }} />
                            </div>
